...
\textbf{Research Assistant, (UBC)}, Vancouver, British Columbia, Canada \hfill Sep 2014 -- Present
\begin{outerlist}
\item[] \textbf{Research Interest: Software Testing}
\item[] \textbf{Advisor: Dr. Ali Mesbah}
\item[] \textbf{Assertions Are Strongly correlated With Test Suite Effectiveness}
\begin{innerlist}
...
\item Built infrastructure to automatically compose test suites of target properties and executed through mutation testing
\item Statistically analyze the experiment results by using correlations, significant tests, and analysis of variance
\item Published at \textbf{ESEC/FSE 2015}
\end{innerlist}
...
\item Built infrastructure to automatically collect assertion related properties, such as assertion content types,  direct/indirect assertion coverage, assertion density, cyclomatic complexity, and etc.
...
\item Math 180	\hfill	9/2013 -- 12/2013
\end{innerlist}

\comment{
\section{Research Experience}

\textbf{Research Assistant}, University of Illinois at Urbana-Champaign, United States.~~~~Advisor: Prof.{Carl Gunter}	
\hfill	3/2015 -- Present
\begin{outerlist}
\item[] \textbf{Acute Care Medical System Replay}	
\begin{innerlist}
\item Conducted a survey on existing record-and-replay tools and algorithms.
\item Modified Arnold to record and replay a medical device.  
\item Designing algorithms for distributed record-and-replay which will be able to record multiple devices.
\end{innerlist}
\end{outerlist}

\halfblankline

\textbf{Research Associate}, Analytics Lab, {HP Labs}, Palo Alto, CA.
\hfill	5/2015 -- 8/2015
\begin{outerlist}
\item[] \textbf{Distributed Large-scale Deep Learning}	
\begin{innerlist}
\item Benchmark existing implementations of deep neural networks and frameworks for distributed machine learning.
\item Benchmark deep neural networks on smartbed sensors data.
\item Develop a framework for distributed deep learning with Apache Spark.
\end{innerlist}
\end{outerlist}

\halfblankline

\textbf{Research Assistant}, \href{http://www.prg.nii.ac.jp/}{Programming Research Laboratory}, \href{http://www.nii.ac.jp/en/}{National Institute of Informatics ~(NII)}, Tokyo, Japan.~~~~Advisor: Prof. \href{http://research.nii.ac.jp/~hu/}{Zhenjiang Hu}	
\hfill	2/2013 -- 5/2013
\begin{outerlist}
\item[] \textbf{Parallel Programming of Graph Problems}	
\begin{innerlist}
\item Designed algorithms to parallelize \textbf{graph optimization problems} using tree decomposition and tree parallelism.
\item Proposed a framework for solving graph problems which provides user-friendly programming interfaces and automatic \textbf{in-black-box parallelization}.
\item Published 1 paper in FHPC'13. 
\end{innerlist}
\end{outerlist}
...
\begin{outerlist}
\item[] \textbf{Program analysis of JavaScript for hidden information}	%\hfill 3/2011 -- 5/2013
\begin{innerlist}
...
\item[] \textbf{Using FindBugs to detect bugs in Scala programs}	%\hfill 9/2011 -- 2/2012
\begin{innerlist}
...
\item Won the Euclid Mathematics Contest in Waterloo
